...
void displayMenu() {
  ...
  // Calculate starting position to display the menu from the bottom
  int startY = SCREEN_HEIGHT - menuLength * 8;
...
void displayDinoGame() {
  ...
  // // Draw ground
  // display.drawLine(0, groundLevel + 8, SCREEN_WIDTH, groundLevel + 12, SSD1306_WHITE);
  ...
  display.setCursor(SCREEN_WIDTH-48, SCREEN_HEIGHT - 8);
  display.print("Score: ");
  display.print(score);
